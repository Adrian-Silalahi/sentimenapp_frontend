    ...
    <div className="p-4 md:p-5 lg:p-6 max-w-container-max mx-auto w-full h-full flex flex-col gap-4 animate-in fade-in duration-500 justify-center">
      <div className="flex flex-col gap-2 max-w-3xl">
        ...
        <p className="font-body-md text-body-md text-slate-600 dark:text-slate-400">
          This process cleans the text from irrelevant HTML elements, tags, and
          entities to ensure the text is pure and ready for the next processing
          stage.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-2">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-body-sm text-body-sm text-slate-600 dark:text-slate-400">
                    Extract data directly from sources before performing
                    cleansing.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl p-5 border border-slate-200 dark:border-slate-800 shadow-sm h-fit">
            ...
            <p className="font-body-sm text-body-sm text-slate-600 dark:text-slate-400 mb-4">
              The following elements will be removed from the text data:
            </p>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                    Removes all tag structures like &lt;div&gt;, &lt;p&gt;,
                    &lt;a&gt;, etc.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                    Converts or removes special codes like &amp;amp;,
                    &amp;nbsp;.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                    Eliminates embedded JavaScript and CSS code snippets.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                    Removes text located inside HTML comment tags.
                  </p>
                </div>
              </div>
            </div>
